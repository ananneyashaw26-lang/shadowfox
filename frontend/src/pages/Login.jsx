    ...
    <div className="min-h-[85vh] flex items-center justify-center px-4 bg-gray-50/50 py-12">
      <div className="w-full max-w-md bg-white rounded-3xl border border-gray-100 shadow-xl p-8 space-y-6">
        ...
        <div className="text-center space-y-1.5">
          ...
          <p className="text-sm text-gray-400 font-medium">Discover & order delicious treats instantly</p>
        </div>
        ...
        <div className="text-center pt-2">
          <p className="text-xs text-gray-400 font-medium">
            New to Zomato?{" "}
            <Link to="/register" className="text-zomatoRed font-bold hover:underline">
              Create an account
            </Link>
          </p>
        </div>
